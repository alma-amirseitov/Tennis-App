...
-- Date: 2026-02-10
-- =====================================================
-- Полная переработка под новые требования:
-- - Auth: телефон + OTP (без email/password)
-- - 4 типа сообществ с верификацией
-- - Конструктор ивентов (8 шагов)
-- - 3 типа чатов (личные, групповые, ивент)
-- - ELO-рейтинг с двусторонним подтверждением
-- - Достижения/бейджи
-- - Карта кортов
-- - Друзья/избранные
-- =====================================================
...
-- =====================================================
-- 3. COURTS (before events — events reference courts)
-- =====================================================
...
-- Now add FK from courts to communities
...
CREATE TABLE matches (
    ...
    -- Score: {"sets": [{"p1": 6, "p2": 4}, {"p1": 3, "p2": 6}, {"p1": 7, "p2": 5, "tiebreak": {"p1": 7, "p2": 3}}]}
    score JSONB,
...
-- SUMMARY
-- =====================================================
-- Tables: 16 core + 2 junction + 2 system = 20 total
--   1. users
--   2. otp_sessions
--   3. refresh_tokens
--   4. courts
...
--  18. user_badges
--  19. player_stats_global
--  20. rating_history
--  21. audit_logs
-- Views: 2 (v_community_leaderboard, v_active_events)
-- Triggers: 10 (updated_at × 8, member_count, participant_count)
-- =====================================================
